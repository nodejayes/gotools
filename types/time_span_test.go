...
func TestNewTimeSpan(t *testing.T) {
	...
	example := NewTimeSpan(*NewNumber(1), *NewNumber(2), *NewNumber(5), *NewNumber(50))
...
func TestNewTimeSpanFromMilliseconds(t *testing.T) {
	...
	g.Expect(example2.Day().AsInt()).To(gomega.Equal(1))
}

func TestNewTimeSpanFromISOString(t *testing.T) {
	g := gomega.NewGomegaWithT(t)
	example1 := NewTimeSpanFromISOString(*NewString("1.22:05:08 200"))
	example2 := NewTimeSpanFromISOString(*NewString("22:05:08 200"))
	example3 := NewTimeSpanFromISOString(*NewString("22:05:08"))
	example4 := NewTimeSpanFromISOString(*NewString("1.22:05:08"))
	example5 := NewTimeSpanFromISOString(*NewString("1."))
	example6 := NewTimeSpanFromISOString(*NewString("-"))
